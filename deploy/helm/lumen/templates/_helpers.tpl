...
under the kustomize layout when installed as `helm install lumen ...`.
*/}}
{{- define "lumen.backend.fullname" -}}
{{ .Release.Name }}-backend
{{- end -}}

{{- define "lumen.frontend.fullname" -}}
{{ .Release.Name }}-frontend
{{- end -}}

{{- define "lumen.postgres.fullname" -}}
...
postgres://$(POSTGRES_USER):$(POSTGRES_PASSWORD)@{{ include "lumen.postgres.fullname" . }}:5432/$(POSTGRES_DB)?sslmode=disable
{{- end -}}
