...
postgres_db="lumen_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://lumen:lumen@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
LUMEN_DEV_VERIFICATION_CODE=888888
LUMEN_SERVER_URL=ws://localhost:${backend_port}/ws
LUMEN_PUBLIC_URL=http://localhost:${backend_port}
