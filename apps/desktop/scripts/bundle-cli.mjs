#!/usr/bin/env node
// Builds the `lumen` CLI from server/cmd/lumen and copies the binary
...
//
// ldflags mirror `make build` so `lumen --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "lumen.exe" : "lumen";
}
