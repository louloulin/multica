...
description: Install Lumen on your iPhone from source, and connect to Cloud or a self-hosted instance.
---

import { Callout } from "fumadocs-ui/components/callout";

The Lumen iOS client is not on the App Store yet. You can build a Release version from the open-source repository on a Mac and install it on your own iPhone. There is no Android client yet.

The installed app connects to Lumen Cloud by default; sign in with your existing account. Workspaces, issues, comments, and run history all live on the server — nothing needs to be synced manually from web or Desktop.
...
The value only needs to be available in your Apple Developer team; it does not affect your Lumen account or workspaces.
...
For mobile development, using the Simulator, or connecting to staging, see [`apps/mobile/README.md`](https://github.com/lumen-ai/lumen/blob/main/apps/mobile/README.md) in the repository.
