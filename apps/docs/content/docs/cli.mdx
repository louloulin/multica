...
# View and search
lumen issue list
lumen issue get MUL-123
lumen issue search "login failure"

# Create and update
lumen issue create --title "Fix login failure"
lumen issue status MUL-123 in_progress
lumen issue assign MUL-123 --to "Backend Agent"

# Comments and runs
lumen issue comment list MUL-123
lumen issue comment add MUL-123 --content "Check the regression tests first"
lumen issue comment update <comment-id> --expected-revision 2 --content "Check the regression tests and release notes"
lumen issue runs MUL-123
```
...
lumen issue comment add MUL-123 --content-stdin < review.md
...
```bash
lumen issue run-messages <task-id> --issue MUL-123
lumen issue cancel-task <task-id> --issue MUL-123
```
