...
Replies stay with the target agent even while its runtime is offline or busy. Lumen does not automatically start the issue assignee after a timeout. To involve another agent, explicitly @-mention it.
