/**
 * Lumen architecture diagram for §1.2 "How Lumen Works".
 *
 ...
 * "Lumen" (metadata store and coordinator).  The asymmetric sizes and the
 * brand-tinted left panel visually argue Lumen's core thesis: AI runs on
      ...
      <div className="flex-1 space-y-5">
        ...
        <div>
          ...
          <div className="text-xs text-muted-foreground mb-2.5">
            Polls work from Lumen. Invokes local AI coding tools:
          </div>
