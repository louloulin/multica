...
// Docs-local stateless Lumen mark — matches @lumen/ui's LumenIcon
...
// packages/ui/components/common/lumen-icon.tsx if the mark changes.
const LUMEN_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Lumen asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Lumen Docs</span>
    ),
  },
  links: [
    {
