 ...
 * yet schematised in @lumen/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@lumen/core/api/schemas";
...
// availability derivation in @lumen/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@lumen/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
