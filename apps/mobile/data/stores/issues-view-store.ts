 ...
 * `@lumen/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@lumen/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@lumen/core/types";
