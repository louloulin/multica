 ...
 *
 * Types are imported via `import type` from @lumen/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @lumen/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Lumen payload size on cellular. */
