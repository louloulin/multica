...
export const metadata: Metadata = {
  ...
  description:
    "Download Lumen for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Lumen",
    description:
      "Get the Lumen desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
