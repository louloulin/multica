 ...
 * `Issues | Lumen` and `Changelog | Lumen` can never drift into two
...
export const SITE_TITLE = "Lumen — Project Management for Human + Agent Teams";

/** Appended to every page-specific title. */
export const TITLE_SUFFIX = " | Lumen";
