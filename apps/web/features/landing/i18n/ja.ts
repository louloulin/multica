...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Lumen は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "営業に相談する",
      worksWith: "20+ の AI コーディングツールに対応",
      imageAlt: "人間と AI エージェントがタスクを管理する Lumen のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。作業をキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を Lumen が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Lumen は Antigravity、Claude Code、CodeBuddy、CodeArts、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、MiniMax Code、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI、ZeroClaw という26種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    ...
    openSource: {
      ...
      description:
        "Lumen は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Lumen を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Lumen はその上に、作業キュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間の作業を自律的にこなせますか?",
          answer:
            "はい。Lumen は、キュー追加・受け取り・実行・完了または失敗まで、作業のライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Lumen のサーバーを経由することはありません。プラットフォームは作業の状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Lumen の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "iPad に Lumen をネイティブでインストールでき、画面の向きも自由です。",
        ...
        },
        {
          ...
          features: [
            ...
            "Lumen をスマホのホーム画面に追加して、アプリのように開けます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクの残りファイルで、そのフォルダーの lumen コマンドが止まりません。",
        ...
        },
        {
          ...
          improvements: [
            "`lumen daemon logs` がログファイルの場所を教えてくれます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Lumen のどのリンクでも、Cmd/Ctrl または中クリックで新しいタブに開けます。",
        ...
        },
        {
          ...
          features: [
            ...
            "lumen や Agent CLI を差し替えると、再起動なしでそのまま反映されます。",
          ],
          improvements: [
        ...
        },
        {
          ...
          improvements: [
            ...
            "多くのワークスペースがあっても、Lumen の起動時にエージェントツールを何度も確認しなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が Lumen 内に残るようになりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 版デスクトップ アプリが lumen-desktop という名前でインストールされます。",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          features: [
            ...
            "LUM-123 のようなタスク番号を入力または貼り付けると、自動でクリックできるタスクリンクになります。",
        ...
        },
        {
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Lumen を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで Lumen タスクを作成し、実行者だけにタスクリンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Lumen ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          fixes: [
            ...
            "セルフホスト：docker-compose.selfhost.yml で LUMEN_SLACK_SECRET_KEY をバックエンド コンテナへ引き渡すようになりました。（コミュニティ報告）",
            "タスク一覧上部の「N 件処理中」チップが、エージェントではなくタスクの数を数えるようになりました。",
            "セルフホストの匿名ソース チャネル送信先を正式な Lumen API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを Lumen にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
            "Slack でエージェントが返信を準備している間、ユーザーのメッセージに 👀 のリアクションが付き、終了時に確実に外れます。",
            "スキル パッケージをローカルの .skill / .zip アーカイブから取り込めるようになりました。",
            "lumen issue 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。タスク Key（LUM-123）または完全な UUID を指定してください。",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Lumen に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Lumen エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5 が Lumen の対応モデルと料金一覧に加わりました。",
            "タスクの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Lumen が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Lumen の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Lumen がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Lumen は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Lumen エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックリストを使えるようになり、タスク内の軽い計画を整理しやすくなりました。",
            "エージェントに Lumen の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Lumen がアプリ、サイト、ドキュメントで日本語に対応しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Lumen がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Lumen for iOS をリリースし、ログイン・ワークスペース・インボックス・タスク・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Lumen のタスクに表示し、状態を同期し、PR がクローズされたときにタスクを自動的に閉じられます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen daemon disk-usage` が、作業ごと・ワークスペースごとのディスク使用量を表示します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen repo checkout --ref` が、ブランチ、タグ、特定のコミットを対象にリポジトリを取得できます。",
            "`lumen agent avatar` が、CLI からエージェントのアバターを直接アップロードします。",
          ...
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`lumen login --token`、CLI 更新の状態、session resume、Kanban 設定、オートパイロットのレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "デーモンの claim polling の Redis fast-path、Lumen Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen agent create/update --custom-env KEY=VALUE` が、エージェントの実行にカスタム環境変数を注入します。",
    ...
    nameLine: {
      prefix: "Lumen \u2014 ",
      emphasis: "\u30e9\u30c6\u30f3\u8a9e",
      rest: "\u3067\u201c\u5149\u201d\u3092\u610f\u5473\u3057\uff0c\u56fd\u969b\u5358\u4f4d\u7cfb\u306b\u304a\u3051\u308b\u5149\u901a\u91cf\uff08luminous flux\uff09\u306e\u5358\u4f4d\u3067\u3082\u3042\u308a\u307e\u3059\u3002\u3053\u306e\u540d\u524d\u306f\u3001\u4eba\u3068\u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u306b\u3088\u3063\u3066\u69cb\u6210\u3055\u308c\u308b\u30c1\u30fc\u30e0\u306b\u5bfe\u3057\u3066\u30d7\u30e9\u30c3\u30c8\u30d5\u30a9\u30fc\u30e0\u304c\u884c\u3046\u3053\u3068\u3092\u8868\u3057\u3066\u3044\u307e\u3059\u2014\u4ed5\u4e8b\u3092\u201c\u898b\u3048\u308b\u201d\u3088\u3046\u306b\u3059\u308b\u3002\u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u306e\u5b9f\u884c\u306f\u3082\u3046\u30bf\u30fc\u30df\u30ca\u30eb\u4e2d\u306e\u9ed1\u3044\u7bb1\u3067\u306f\u3042\u308a\u307e\u305b\u3093\u3002\u8a08\u753b\u3001\u6c7a\u65ad\u3001\u30b3\u30fc\u30c9\u306e diff \u304c\u540c\u3058\u30a4\u30b7\u30e5\u30fc\u306b\u7d4c\u7531\u3057\u3066\u770b\u677f\u4e0a\u3067\u540c\u50da\u3068\u4e26\u3093\u3067\u898b\u3048\u307e\u3059\u3002",
    },
    paragraphs: [
      "\u3053\u306e\u540d\u524d\u306f\u3001\u307e\u305f 1960 \u5e74\u4ee3\u306e\u5148\u99c6\u7684\u306a\u30aa\u30da\u30ec\u30fc\u30c6\u30a3\u30f3\u30b0\u30b7\u30b9\u30c6\u30e0 Multics \u3078\u306e\u9759\u304b\u306a\u6b4c\u8d64\u3067\u3059\u3002Multics \u306f\u8907\u6570\u306e\u30e6\u30fc\u30b6\u30fc\u304c 1 \u53f0\u306e\u30de\u30b7\u30f3\u3092\u3001\u307e\u308b\u3067\u5404\u81ea\u304c\u72ec\u308a\u5360\u3081\u3057\u3066\u3044\u308b\u304b\u306e\u3088\u3046\u306b\u5171\u6709\u3067\u304d\u308b\u201c\u30bf\u30a4\u30e0\u30b7\u30a7\u30a2\u30ea\u30f3\u30b0\u201d\u3068\u3044\u3046\u6982\u5ff5\u3092\u4e16\u306b\u5e83\u3081\u307e\u3057\u305f\u3002Unix \u306f\u3001\u305d\u306e Multics \u3092\u3042\u3048\u3066\u30b7\u30f3\u30d7\u30eb\u306b\u3059\u308b\u5f62\u3067\u751f\u307e\u308c\u307e\u3057\u305f\u3002\u4e00\u4eba\u306e\u30e6\u30fc\u30b6\u30fc\u3001\u3072\u3068\u3064\u306e\u30bf\u30b9\u30af\u3001\u3072\u3068\u3064\u306e\u7dbe\u96e8\u306a\u54f2\u5b66\u3067\u3059\u3002\u3064\u307e\u308a\u3001\u540c\u3058\u3088\u3046\u306a\u8f49\u6298\u70b9\u304c\u3075\u305f\u305f\u3073\u8a2a\u308c\u3066\u3044\u308b\u3068\u79c1\u305f\u3061\u306f\u8003\u3048\u3066\u3044\u307e\u3059\u3002",
      "\u3053\u306e\u6570\u5341\u5e74\u3001\u30bd\u30d5\u30c8\u30a6\u30a8\u30a2\u30c1\u30fc\u30e0\u306f\u4e8b\u5b9f\u4e0a\u30b7\u30f3\u30b0\u30eb\u30b9\u30ec\u30c3\u30c9\u3067\u50cd\u3044\u3066\u304d\u307e\u3057\u305f\u3002\u30a8\u30f3\u30b8\u30cb\u30a2\u4e00\u4eba\u304c\u30bf\u30b9\u30af\u3092\u4e00\u3064\u8ca0\u3044\u3001\u4e00\u5ea6\u306b\u4e00\u3064\u306e\u6587\u8108\u3060\u3051\u3092\u5207\u308a\u66ff\u3048\u306a\u304c\u3089\u9032\u3081\u308b\u3002AI \u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u306f\u3001\u305d\u306e\u65b9\u7a0b\u5f0f\u3092\u5909\u3048\u307e\u3059\u3002Lumen \u306f\u30bf\u30a4\u30e0\u30b7\u30a7\u30a2\u30ea\u30f3\u30b0\u3092\u3075\u305f\u305f\u3073\u53ec\u308a\u623b\u3057\u307e\u3059\u3002\u305f\u3060\u3057\u4eca\u56de\u306f\u3001\u30b7\u30b9\u30c6\u30e0\u3092\u591a\u91cd\u5229\u7528\u3059\u308b\u300c\u30e6\u30fc\u30b6\u30fc\u300d\u304c\u4eba\u9593\u3068\u81ea\u5f8b\u7684\u306a\u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u306e\u4e21\u65b9\u3067\u3042\u308b\u6642\u4ee3\u306b\u5408\u308f\u305b\u3066\u3002\u5c0f\u3055\u306a\u30c1\u30fc\u30e0\u306f\u5c0f\u3055\u304f\u52d5\u304f\u5fc5\u8981\u306f\u3042\u308a\u307e\u305b\u3093\u2014\u6b63\u3057\u3044\u30b7\u30b9\u30c6\u30e0\u304c\u3042\u308c\u3070\u3001\u30a8\u30f3\u30b8\u30cb\u30a2\u4e8c\u540d\u3068\u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u4e00\u7fa4\u304c\u4e8c\u5341\u4eba\u306e\u3088\u3046\u306b\u52d5\u3051\u307e\u3059\u3002",
      "Lumen \u3067\u306f\u3001\u30a8\u30fc\u30b8\u30a7\u30f3\u30c8\u306f\u4e00\u7d1a\u306e\u30c1\u30fc\u30e0\u30e1\u30f3\u30d0\u30fc\u3067\u3059\u3002\u4eba\u9593\u306e\u540c\u50da\u3068\u307e\u3063\u305f\u304f\u540c\u3058\u3088\u3046\u306b\u3001\u30bf\u30b9\u30af\u3092\u5272\u308a\u5f53\u3066\u3089\u308c\u3001\u9032\u6368\u3092\u5831\u544a\u3057\u3001\u884c\u304d\u8a70\u307e\u308a\u3092\u77e5\u3089\u305b\u3001\u30b3\u30fc\u30c9\u3092\u30ea\u30ea\u30fc\u30b9\u3057\u307e\u3059\u3002\u62c5\u5f53\u8005\u306e\u9078\u629e\u3001\u30a2\u30af\u30c6\u30a3\u30d3\u30c6\u30a3\u30bf\u30a4\u30e0\u30e9\u30a4\u30f3\u3001\u4f5c\u696d\u306e\u30e9\u30a4\u30d5\u30b5\u30a4\u30af\u30eb\u3001\u305d\u3057\u3066\u30e9\u30f3\u30bf\u30a4\u30e0\u306e\u30a4\u30f3\u30d5\u30e9\u306f\u3001\u3059\u3079\u3066\u3053\u306e\u524d\u63d0\u3092\u4e2d\u5fc3\u306b\u3001\u6700\u521d\u304b\u3089\u8a2d\u8a08\u3055\u308c\u3066\u3044\u307e\u3059\u3002",
      "\u30d7\u30e9\u30c3\u30c8\u30d5\u30a9\u30fc\u30e0\u306f\u5b8c\u5168\u306a\u30aa\u30fc\u30d7\u30f3\u30bd\u30fc\u30b9\u3067\u3001\u30bb\u30eb\u30d5\u30db\u30b9\u30c8\u53ef\u80fd\u3067\u3059\u3002\u30c7\u30fc\u30bf\u306f\u3042\u306a\u305f\u306e\u30a4\u30f3\u30d5\u30e9\u306b\u6b8b\u308a\u307e\u3059\u3002\u3059\u3079\u3066\u306e\u30b3\u30fc\u30c9\u3092\u78ba\u8a8d\u3057\u3001API \u3092\u62e1\u5f35\u3057\u3001\u597d\u304d\u306a LLM \u30d7\u30ed\u30d0\u30a4\u30c0\u30fc\u3092\u63a5\u7d9a\u3057\u3001\u30b3\u30df\u30e5\u30cb\u30c6\u30a3\u306b\u8ca2\u732e\u3067\u304d\u307e\u3059\u3002",
    ],
    cta: "GitHub \u3067\u898b\u308b",
  },
    download: {
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Lumen チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Lumen をどのように利用、または活用するご予定ですか?",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Lumen を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Lumen を連携" },
      ...
      consent: {
        intro:
          "Lumen, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Lumen, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Lumen からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Lumen, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Lumen チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
