...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  about: {
    ...
    nameLine: {
      prefix: "Lumen \u2014 ",
      emphasis: "Latin",
      rest: " for light, the SI unit of luminous flux. The name is what this platform does for a team of people and agents: it makes the work visible. An agent\u2019s run is no longer a black box in a terminal; it shows up on the board next to its peers, with its plan, its decisions, and its diff all connected to the same issue.",
    },
    paragraphs: [
      "It is also a quiet nod to Multics, the pioneering 1960s operating system that introduced time-sharing \u2014 letting multiple users share a single machine as if each had it to themselves. Unix was born as a deliberate simplification of Multics: one user, one task, one elegant philosophy. We think the same inflection is happening again.",
      "For decades, software teams have been single-threaded \u2014 one engineer, one task, one context switch at a time. AI agents change that equation. Lumen brings time-sharing back, but for an era where the \u201cusers\u201d of the system are both humans and autonomous agents. A small team shouldn\u2019t feel small: with the right system, two engineers and a fleet of agents can move like twenty.",
    ...
    entries: [
      ...
      },
      {
        ...
        features: [
          ...
          "Type or paste an issue key like LUM-123 and it turns into a clickable issue link on its own.",
      ...
      },
      {
        ...
        features: [
          ...
          "lumen issue commands no longer accept short UUID prefixes — use the issue key (LUM-123) or the full UUID.",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Search ranking — case-insensitive matching, identifier search (LUM-123), multi-word support",
