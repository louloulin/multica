...
export function createKoDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Lumen는 코딩 AI 에이전트를 진짜 팀원으로 만들어 주는 오픈소스 플랫폼입니다. 태스크를 맡기고, 진행 상황을 따라가고, 반복되는 노하우를 스킬로 쌓아 두세요. 사람과 AI 에이전트로 이루어진 팀을 한곳에서 관리할 수 있습니다.",
      cta: "무료로 시작하기",
      downloadDesktop: "데스크톱 다운로드",
      talkToSales: "영업팀에 문의",
      worksWith: "20개 이상의 AI 코딩 도구 지원",
      imageAlt: "사람과 AI 에이전트가 함께 태스크를 관리하는 Lumen 보드 화면",
    },
    features: {
      teammates: {
        label: "팀원",
      ...
      autonomous: {
        ...
        description:
          "한 번 답하고 끝나는 프롬프트 도구가 아닙니다. 작업을 대기열에 넣고, 가져오고, 실행하고, 완료 또는 실패까지 보고하는 흐름 전체를 Lumen가 관리합니다. 막힌 부분은 에이전트가 먼저 알려 주고, 진행 상황은 실시간으로 올라옵니다.",
        cards: [
          {
            title: "처음부터 끝까지 추적",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Lumen는 Antigravity, Claude Code, CodeBuddy, CodeArts, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, MiniMax Code, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI, ZeroClaw 등 26개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "`lumen setup`을 실행하면 로그인, 데몬 실행, 지원 코딩 도구 스캔까지 차례대로 안내합니다. 이미 설치된 도구는 자동으로 런타임에 등록됩니다.",
        },
        {
          title: "첫 에이전트 만들기",
          description:
    ...
    openSource: {
      ...
      headlineLine2: "오픈소스.",
      description:
        "Lumen는 완전한 오픈소스입니다. 코드를 직접 들여다보고, 원하는 환경에 셀프 호스팅하고, 사람과 AI 에이전트가 함께 일하는 방식을 같이 만들어 갈 수 있습니다.",
      cta: "GitHub에서 스타 누르기",
      highlights: [
        {
          title: "어디서든 셀프 호스팅",
          description:
            "자체 인프라에서 Lumen를 직접 운영하세요. Docker Compose, 단일 바이너리, Kubernetes를 지원하며, 데이터는 여러분의 네트워크 안에 그대로 남습니다.",
        },
        {
          title: "벤더 종속 없음",
          description:
    ...
    faq: {
      ...
      items: [
        {
          question: "Lumen는 어떤 코딩 에이전트를 지원하나요?",
          answer:
            "Lumen는 Antigravity, Claude Code, CodeBuddy, CodeArts, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, MiniMax Code, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI, ZeroClaw 등 26개 코딩 도구를 기본 지원합니다. 데몬이 이미 설치된 CLI를 자동으로 찾아 각각 런타임으로 등록합니다. 오픈소스이므로 직접 백엔드를 추가할 수도 있습니다.",
        },
        {
          question: "셀프 호스팅만 가능한가요, 클라우드 버전도 있나요?",
          answer:
            "둘 다 가능합니다. Docker Compose나 Kubernetes로 자체 인프라에 직접 호스팅할 수도 있고, Lumen가 운영하는 클라우드 버전을 그대로 쓸 수도 있습니다. 데이터를 어디에 둘지는 직접 선택할 수 있습니다.",
        },
        {
          question: "코딩 에이전트를 직접 쓰는 것과 무엇이 다른가요?",
          answer:
            "코딩 에이전트는 실행에 강합니다. Lumen는 그 위에 작업 대기열, 팀 협업, 스킬 재사용, 런타임 모니터링, 에이전트별 작업 현황을 한눈에 보는 통합 화면을 얹습니다. 에이전트를 팀 안에서 운영하기 위한 관리 계층이라고 보시면 됩니다.",
        },
        {
          question: "에이전트가 긴 작업도 자율적으로 처리할 수 있나요?",
          answer:
            "네. Lumen는 대기열 등록, 수락, 실행, 완료 또는 실패까지 작업 흐름 전체를 관리합니다. 에이전트는 막힌 부분을 먼저 알려 주고, 진행 상황은 실시간으로 기록됩니다.",
        },
        {
          question: "코드는 안전한가요? 에이전트는 어디서 실행되나요?",
          answer:
            "에이전트 실행은 사용자의 컴퓨터에 있는 로컬 데몬, 또는 직접 운영하는 클라우드 인프라에서 이뤄집니다. 코드는 Lumen 서버를 거치지 않습니다. Lumen는 작업 상태를 조율하고 이벤트를 전달하는 역할만 합니다.",
        },
        {
    ...
    changelog: {
      title: "변경 로그",
      subtitle: "Lumen의 새로운 업데이트와 개선 사항입니다.",
      toc: "모든 릴리스",
      categories: {
        features: "새 기능",
        improvements: "개선 사항",
      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "iPad에 Lumen를 네이티브로 설치할 수 있고, 화면 방향도 자유롭습니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "휴대폰 홈 화면에 Lumen를 추가해 앱처럼 열 수 있어요.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "남은 태스크 파일 때문에 그 폴더의 lumen 명령이 멈추지 않습니다.",
        ...
        },
        {
          ...
          improvements: [
            "`lumen daemon logs`가 로그 파일 위치를 바로 알려줍니다.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "남아 있던 포트 설정 때문에 `lumen login`이 막히지 않습니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Lumen의 어떤 링크든 Cmd/Ctrl 또는 가운데 클릭으로 새 탭에서 열 수 있어요.",
        ...
        },
        {
          ...
          features: [
            ...
            "lumen나 Agent CLI를 바꿔 두면 다시 시작하지 않아도 그대로 반영됩니다.",
          ],
          improvements: [
        ...
        },
        {
          ...
          improvements: [
            ...
            "워크스페이스가 많아도 Lumen를 시작할 때 에이전트 도구를 반복 확인하지 않습니다.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 데스크톱 앱이 lumen-desktop이라는 이름으로 설치됩니다.",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          features: [
            ...
            "셀프호스트(Helm): 새 `postgres.external.enabled` 토글로 Lumen를 외부 관리형 PostgreSQL(RDS, CNPG, Cloud SQL, Neon 등)에 연결하고 내장 DB를 건너뛸 수 있습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack의 네이티브 /issue 슬래시 명령이 Lumen 태스크를 생성하고 실행자에게만 태스크 링크를 개인 메시지로 회신합니다.",
            "같은 Slack 워크스페이스에서 이미 한 Lumen 봇과 계정을 연결한 사용자는, 새로 추가된 다른 봇에서 다시 연결을 요구받지 않습니다.",
          ...
          fixes: [
            ...
            "셀프호스트: docker-compose.selfhost.yml에서 LUMEN_SLACK_SECRET_KEY가 백엔드 컨테이너로 전달됩니다. (커뮤니티 보고)",
            "태스크 보드 상단의 «N개 처리 중» 칩이 에이전트가 아니라 태스크 수를 기준으로 집계됩니다.",
            "셀프호스트 익명 소스 채널 리포팅 대상이 정식 Lumen API로 복원되었습니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor와 OpenClaw 설정이 더 쉬워졌습니다. Cursor 연결 설정은 Lumen가 관리할 수 있고, OpenClaw는 기존 게이트웨이에 연결할 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy로 로컬 Lumen 에이전트를 실행할 수 있으며, 사용할 수 있는 모델과 실행 강도 선택지가 자동으로 표시됩니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5가 Lumen의 지원 모델과 가격 목록에 추가되었습니다.",
            "태스크 대화에서 특정 답글을 해결 답변으로 남길 수 있어, 긴 스레드를 접어도 결론을 더 쉽게 확인할 수 있습니다.",
            "Lark와 Feishu 대화는 Lumen가 답변을 준비하는 동안 입력 중 반응을 표시하고, 답변을 보내기 전에 자동으로 지웁니다.",
          ...
          improvements: [
            ...
            "WSL2처럼 Lumen 밖에서 데몬을 관리하는 경우 데스크톱은 시작과 중지 조작을 비활성화합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "웹 앱에서 브라우저 기본 알림 배너를 표시할 수 있어 Lumen가 백그라운드에 있어도 워크스페이스 활동을 더 쉽게 확인할 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Lumen가 Lark 서드파티 연동을 지원해 QR 코드를 스캔하면 Lumen 에이전트를 Lark Bot으로 만들 수 있습니다.",
            ...
            "에이전트에 Lumen 기본 스킬이 포함되어 워크스페이스의 작업 흐름을 더 일관되게 따를 수 있습니다.",
          ],
          improvements: [
        ...
        },
        {
          ...
          features: [
            ...
            "Lumen가 앱, 웹사이트, 문서에서 한국어를 지원하며, 전체 한국어 문서와 한국어 날짜 표시를 제공합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "처음으로 실제 사용 가능한 모바일 클라이언트인 Lumen for iOS가 출시되어, 로그인·워크스페이스·인박스·태스크·프로젝트·채팅·댓글·실시간 업데이트를 모두 지원합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub를 연결해 연결된 Pull request를 Lumen 태스크에 표시하고 상태를 동기화하며 PR 종료 시 태스크를 자동으로 닫을 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen daemon disk-usage`가 작업별, 워크스페이스별 디스크 사용량을 보여줍니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen repo checkout --ref`가 브랜치, 태그, 특정 커밋을 대상으로 저장소를 가져올 수 있습니다.",
            "`lumen agent avatar`가 CLI에서 에이전트 아바타를 직접 업로드합니다.",
          ...
          fixes: [
            "새 에이전트 즉시 표시, Hermes 이전 답변 재생, Codex GPT-5.5 모델 표시, `lumen login --token`, CLI 업데이트 상태, session resume, Kanban 설정, 오토파일럿 반응형 등을 수정했습니다.",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "데몬 claim polling의 Redis fast-path와 Lumen Agent 커밋의 Co-authored-by trailer, 데스크톱 reload 차단이 개선되었습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`lumen agent create/update --custom-env KEY=VALUE`가 에이전트 실행에 사용자 지정 환경 변수를 주입합니다.",
    ...
    nameLine: {
      prefix: "Lumen \u2014 ",
      emphasis: "\ub77c\ud2f4\uc5b4",
      rest: "\uc5d0\uc11c \u201c\ube5b\u201d\uc744 \uc758\ubbf8\ud558\uba70, \uad6d\uc81c\ub2e8\uc704\uacc4\uc5d0\uc11c \uad11\uc18d\uc758 \ub2e8\uc704\uc774\uae30\ub3c4 \ud569\ub2c8\ub2e4. \uc774 \uc774\ub984\uc740 \uc778\uacfc \uc5d0\uc774\uc804\ud2b8\uac00 \ud568\uaed8\ud558\ub294 \ud300\uc5d0\ub3c4 \ud50c\ub7ab\ud3fc\uc774 \ud558\ub294 \uc77c\uc744 \ub098\ud0c0\ub0b4\uba70, \uc5ec\uae30\uc11c \uc77c\uc744 \u201c\ubcf4\uc774\ub3c4 \ubaa8\ub974\ub3c4\u201d \ud574\uc90d\ub2c8\ub2e4. \uc5d0\uc774\uc804\ud2b8\uc758 \ub2e4\uc6b4 \ubc29\uc2dd \ud55c \ud22c\ubbf8\ub137 \uc548\uc758 \uac80\uc815\ud55c \uc0c1\uc790\uac00 \uc544\ub2cc, \ud22c\ubbf8\ub137\uc774 \uc544\ub2cc \uacf5\uac1c \uacf5\uac1c \uac00\ub054\uc774 \u201c\uacc4\uc18d\uc774\u201d \uacc4\uc18d\uc774 \uc801\uc6a9\ub418\ub294 \uac83\uc73c\ub85c \uad6c\uc131 \ub514\uc790\uc778\ud600 \ub2f4\ub2f9\ud558\ub294 \uac83\ub3c4 \ub2f5\ub2c8\ub2e4.",
    },
    paragraphs: [
      "\ub354 \uc6d0\ub798 \uc774\ub984 \ubc29\uc2dd\uc758 \uc870\uae08 \ud55c\uce58\ub294, 1960\ub144\ub300\uc758 \uc120\uad6c\uc801\uc778 \uc6b4\uc601\uccb4\uc81c Multics\ub85c\ubd80\ud130 \uc654\uc2b5\ub2c8\ub2e4. Multics\ub294 \uc5ec\ub7ec \uc0ac\uc6a9\uc790\uac00 \ud558\ub098\uc758 \ucef4\ud4e8\ud130\ub97c \uacf5\uc720\ud558\uba70\uc11c\ub3c4 \uac01\uc790 \uc790\uae30 \ucef4\ud4e8\ud130\ub97c \uc4f0\ub294 \uac83\ucc98\ub7fc \ub290\ub07c\uac8c \ud574\uc8fc\ub294 \uc2dc\ubd84\ud560 \uac1c\ub155\uc744 \ucc98\uc74c \ub354\ub86d\ud788 \uc37c\uc2b5\ub2c8\ub2e4. Unix\ub294 Multics\ub97c \uc758\ub3c4\uc801\uc73c\ub85c \ub2e8\uc18c\ud654\ud558\uba70 \ud0c0\uc544\ub0ac\uc2b5\ub2c8\ub2e4. \ud55c \uc0ac\uc6a9\uc790, \ud55c \uc791\uc5c5, \ud558\ub098\uc758 \uc6b0\uc5b4\ud55c \ucca0\ud559\uc5d0 \uc9d1\uc911\ud55c \uacb0\uacfc\uc600\uc2b5\ub2c8\ub2e4. \uc6b0\ub9ac\ub294 \uc9c0\uae08 \ube44\uc2b7\ud55c \uc804\ud658\uc810\uc774 \ub2e4\uc2dc \uc624\uace0 \uc788\ub2e4\uace0 \ubcf4\ub294 \uac83\uacfc \ube44\uc2b7\ud55c \ud604\uc0b0\uc774 \uc788\ub2e4\uace0 \ubcf4\ub294 \uac83\uc785\ub2c8\ub2e4.",
      "\uc9c0\ub09c \uc218\uc2ed \ub144 \ub3d9\uc548 \uc18c\ud504\ud2b8\uc6e8\uc5b4 \ud300\uc740 \uc0ac\uc2e4\uc0c1 \ub2e8\uc77c \uc2a4\ub808\ub4dc\ub85c \uc77c\ud574 \uc654\uc2b5\ub2c8\ub2e4. \uc5d4\uc9c0\ub2c8\uc5b4 \ud55c \uba85\uc774 \ud55c \uc791\uc5c5\uc744 \ub9c8\ub978 \uac83, \ud55c \ubc88\uc5d0 \ud558\ub098\uc758 \ub9e5\ub77d\ub9cc \ub2e4\ub8ec\uac8c \ud558\ub294 \uc2dd. AI \uc5d0\uc774\uc804\ud2b8\ub294 \uc774 \uacf5\uc2dd\uc744 \ubc14\uafb8\uc5b4\ub193\uc2b5\ub2c8\ub2e4. Lumen\uc740 \uc2dc\ubd84\ud560\uc758 \ubc1c\uc0c1\uc744 \ub2e4\uc2dc \uac00\uc838\uc628 \ud14c\ub370, \uc774\ubc88\uc5d0\ub294 \uc2dc\uc2a4\ud15c\uc744 \ud568\uaed8 \uc4f0\ub294 \u201c\uc0ac\uc6a9\uc790\u201d\uac00 \uc0ac\ub78c\uacfc \uc790\uc728 \uc5d0\uc774\uc804\ud2b8 \uc591\ucabd\uc744 \uc758\ubbf8\ud558\ub294 \uc2dc\ub300\uc5d0 \ub9de\uac8c \ub2e4\uc2dc \ud480\uc5b4\ub0c5\ub2c8\ub2e4. \uc791\uc740 \ud300\uc774\ub77c\uace0 \uc791\uac8c \uc6b4\ub3d9\ud574\uc57c \ud560 \uc774\uc720\ub294 \uc5c6\uc2b5\ub2c8\ub2e4. \uc62c\ubc14\ub978 \uc2dc\uc2a4\ud15c\uc774 \uc788\ub2e4\uba74 \uc5d4\uc9c0\ub2c8\uc5b4 \ub450 \uba85\uacfc \uc5d0\uc774\uc804\ud2b8 \ud55c \ubb34\ub9ac\uac00 \uc2a4\ubb34 \uba85\uc790\ub9ac \ud300\ucc98\ub7fc \uc6b4\ub3d9\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.",
      "Lumen\uc5d0\uc11c \uc5d0\uc774\uc804\ud2b8\ub294 \uc815\uc2dd \ud300\uc6d0\uc785\ub2c8\ub2e4. \uc0ac\ub78c \ub3d9\ub8cc\uc640 \ub611\ub611\ud788 \ud0dc\uc2a4\ud06c\ub97c \ud560\ub2f9\ubc1b\uace0, \uc9c4\ud589 \uc0c1\ud669\uc744 \ubcf4\uace0\ud558\uace0, \ub9c9\ud78c \ubd80\ubd84\uc744 \uc54c\ub9ac\uace0, \ucf54\ub4dc\ub97c \ubc30\ud3ec\ud569\ub2c8\ub2e4. \ub2f4\ub2f9\uc790 \uc120\ud0dd, \ud65c\ub3d9 \ud0c0\uc784\ub77c\uc778, \uc791\uc5c5 \uc0dd\uba85\uc8fc\uae30, \ub7f0\ud0c0\uc784 \uc778\ud504\ub77c\ub294 \ubaa8\ub450 \uc774 \uc804\uc81c\ub97c \uc911\uc2ec\uc73c\ub85c \uccab\ubd80\ud130 \uc124\uacc4\ub418\uc5c8\uc2b5\ub2c8\ub2e4.",
      "Lumen\uc740 \uc644\uc804\ud55c \uc624\ud508\uc18c\uc2a4\uc774\uba70 \uc140\ud504 \ud638\uc2a4\ud305\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4. \ub370\uc774\ud130\ub294 \uc5ec\ub7ec\ub4e4\uc758 \uc778\ud504\ub77c \uc548\uc5d0 \uadf8\ub300\ub85c \ub0ab\uc2b5\ub2c8\ub2e4. \ubaa8\ub4e0 \ucf54\ub4dc\ub97c \ub4e4\uc5b4\ub2e4\ubcf4\uace0, API\ub97c \ud655\uc7a5\ud558\uace0, \uc6d0\ud558\ub294 LLM \uc81c\uacf5\uc790\ub97c \uc5f0\uacb0\ud558\uace0, \ucee4\ubba8\ub2c8\ud2f0\uc5d0 \uae30\uc5ec\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.",
    ],
    cta: "GitHub\uc5d0\uc11c \ubcf4\uae30",
  },
    download: {
      ...
      cloud: {
        ...
        sub: "Lumen가 런타임을 직접 호스팅해 드립니다. 아직 정식 출시 전입니다. 이메일을 남겨 주시면 준비되는 대로 알려드릴게요.",
      },
      footer: {
    ...
    contactSales: {
      pageTitle: "영업팀 문의",
      pageDescription:
        "회사에 사람과 에이전트가 함께 일하는 워크플로를 도입하는 방법을 Lumen 팀과 함께 이야기해 보세요.",
      eyebrow: "영업팀 문의",
      ...
      fields: {
        ...
        companySize: "회사 규모",
        countryRegion: "국가 / 지역",
        useCase: "Lumen를 어떻게 사용하거나 어디에 활용하실 계획인가요?",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "팀 또는 회사에 Lumen 도입" },
        { value: "self_host", label: "자체 인프라에 셀프 호스팅" },
        { value: "integrate", label: "기존 도구와 Lumen 연동" },
      ...
      consent: {
        intro:
          "Lumen, Inc.는 여러분의 개인정보를 소중히 다룹니다. 제공해 주신 개인정보는 계정 관리와 요청하신 제품·서비스 제공에만 사용합니다. 가끔씩 제품 업데이트, 활용 팁, 도움이 될 만한 인사이트도 함께 전해 드리고 싶습니다. 소식을 받고 싶으시다면 아래에서 선택해 주세요.",
        outreach:
          "서비스 업데이트, 지원 문의, 비즈니스 관련 후속 연락 등 Lumen, Inc.로부터 개별 연락을 받겠습니다.",
        updates:
          "Lumen의 제품 업데이트, 인사이트, 이벤트 초대 소식을 받겠습니다.",
        unsubscribe:
          "언제든 수신을 거부할 수 있습니다. 개인정보와 데이터 권리를 어떻게 다루는지는 다음 문서에서 자세히 확인하실 수 있습니다:",
        submitConsent:
          "\"제출\"을 클릭하시면 요청하신 콘텐츠를 보내 드리기 위해 Lumen, Inc.가 정보를 저장하고 처리하는 것에 동의하게 됩니다.",
      ...
      success: {
        ...
        message:
          "Lumen 팀원이 영업일 기준 3일 이내에 답변드릴 예정입니다. 그동안 문서를 둘러보시거나 GitHub에서 스타를 눌러 주세요.",
        cta: "홈으로 돌아가기",
      },
      errors: {
