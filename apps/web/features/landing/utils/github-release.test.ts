...
function completeAssets(version: string) {
  return [
    `lumen-desktop-${version}-mac-arm64.dmg`,
    `lumen-desktop-${version}-mac-arm64.zip`,
    `lumen-desktop-${version}-mac-x64.dmg`,
    `lumen-desktop-${version}-mac-x64.zip`,
    `lumen-desktop-${version}-windows-x64.exe`,
    `lumen-desktop-${version}-windows-arm64.exe`,
    `lumen-desktop-${version}-linux-x86_64.AppImage`,
    `lumen-desktop-${version}-linux-amd64.deb`,
    `lumen-desktop-${version}-linux-x86_64.rpm`,
    `lumen-desktop-${version}-linux-arm64.AppImage`,
    `lumen-desktop-${version}-linux-arm64.deb`,
    `lumen-desktop-${version}-linux-aarch64.rpm`,
  ].map((name) => ({
    name,
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/lumen-ai/lumen/releases/tag/${overrides.tag}`,
