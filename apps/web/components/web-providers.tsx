...
import type { LocaleResources, SupportedLocale } from "@lumen/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears lumen_token).
// Sunset: once telemetry shows <1% of sessions still carry lumen_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("lumen_token"));
  } catch {
    return false;
  }
}
