 ...
 * lumen CLI to be at least this version — older daemons either
 ...
 *
 * Frontend-only constant: there is no server preview endpoint computing this,
 * so there is no server twin to keep in lockstep with.
 */
