...
const AGENT_STORAGE_KEY = "lumen:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "lumen:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "lumen:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "lumen:chat:drafts";
/** Draft attachment records per workspace: { [sessionId]: Attachment[] }. */
const DRAFT_ATTACHMENTS_KEY = "lumen:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "lumen:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "lumen:chat:pending-send-restores";
/**
...
const CHAT_WIDTH_KEY = "lumen:chat:width";
const CHAT_HEIGHT_KEY = "lumen:chat:height";
const CHAT_EXPANDED_KEY = "lumen:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "lumen:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "lumen:chat:floatingChatEnabled";
