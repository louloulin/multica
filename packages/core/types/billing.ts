// Mirrors the lumen-cloud Billing module response shapes
// (lumen-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — lumen-api itself does
