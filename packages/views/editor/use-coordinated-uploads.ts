 ...
 * coordinator (`@lumen/core/drafts`), not by the React component that
...
import {
  ...
  type DraftUpload,
} from "@lumen/core/drafts";
import { createSafeId } from "@lumen/core/utils";
import { contentReferencesAttachment, type Attachment } from "@lumen/core/types";
import {
  toUploadResult,
  type UploadContext,
  type UploadResult,
} from "@lumen/core/hooks/use-file-upload";
import { MAX_FILE_SIZE } from "@lumen/core/constants/upload";
