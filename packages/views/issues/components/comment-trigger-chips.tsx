...
import type { CommentTriggerPreviewAgent, CommentTriggerOutcome } from "@lumen/core/types";
import { useAgentPresenceDetail } from "@lumen/core/agents";
import { mentionLabelsByTarget } from "@lumen/core/issues/comment-trigger-outcomes";
...
import { AVATAR_SIZE_PX } from "@lumen/ui/lib/avatar-size";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
