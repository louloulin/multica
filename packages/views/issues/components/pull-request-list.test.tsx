...
import type { GitHubPullRequest } from "@lumen/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@lumen/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@lumen/core/github/queries")>(
    "@lumen/core/github/queries",
  );
  return {
    ...actual,
