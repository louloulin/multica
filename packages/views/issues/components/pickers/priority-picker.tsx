...
import type { IssuePriority, UpdateIssueRequest } from "@lumen/core/types";
import { PRIORITY_DISPLAY_ORDER, PRIORITY_CONFIG } from "@lumen/core/issues/config";
    ...
    >
      ...
      {PRIORITY_DISPLAY_ORDER.map((p) => {
        ...
        return (
          ...
          >
            <span className={`inline-flex items-center gap-1 rounded-xs px-1.5 py-0.5 text-caption font-medium ${c.badgeBg} ${c.badgeText}`}>
