...
import type { AgentTask, Issue, IssueStatusEntry, Label, TimelineEntry } from "@lumen/core/types";
import { issueKeys } from "@lumen/core/issues/queries";
import { issueStatusKeys } from "@lumen/core/issue-statuses";
import { I18nProvider } from "@lumen/core/i18n/react";
import { toast } from "sonner";
import { useResolvedExpandStore } from "@lumen/core/issues/stores/resolved-expand-store";
import {
  DEFAULT_SUB_ISSUE_ROW_PROPERTIES,
  useSubIssueDisplayStore,
} from "@lumen/core/issues/stores/sub-issue-display-store";
...
// @lumen/core/hooks.tsx). vi.mock("@lumen/core/paths") only intercepts
...
// Mock @lumen/core/workspace/hooks
...
vi.mock("@lumen/core/issues/stores", async () => ({
  ...
  ...(await vi.importActual<
    typeof import("@lumen/core/issues/stores/resolved-expand-store")
  >("@lumen/core/issues/stores/resolved-expand-store")),
  ...
  ...(await vi.importActual<
    typeof import("@lumen/core/issues/stores/sub-issue-display-store")
  >("@lumen/core/issues/stores/sub-issue-display-store")),
  // Real store, in-memory (no localStorage): backs the sub-issues section's
  // collapsed state.
  ...(await vi.importActual<
    typeof import("@lumen/core/issues/stores/sub-issues-collapse-store")
  >("@lumen/core/issues/stores/sub-issues-collapse-store")),
...
// Mock react-resizable-panels (used by @lumen/ui/components/ui/resizable)
