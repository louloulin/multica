...
import { pluginSurfaceLaunchOptions } from "@lumen/core/plugins";
import type { PluginInstallation, PluginSurface } from "@lumen/core/types";
...
export function PluginSurfaceFrame({ wsId, installation, surface, issueId, className }: PluginSurfaceFrameProps) {
  ...
  useEffect(() => {
    ...
    const onMessage = (event: MessageEvent) => {
      ...
      if (type !== "lumen:plugin-surface-error" &&
          type !== "lumen:plugin-surface-navigated" &&
          type !== "lumen:plugin-surface-navigation-blocked") return;
      ...
      if (type === "lumen:plugin-surface-error") setFailedSurfaceInstance(surfaceInstance);
