...
import { slackInstallationsOptions, slackKeys } from "@lumen/core/slack";
import { api } from "@lumen/core/api";
import type { SlackInstallation } from "@lumen/core/types";
...
// path is per-agent (each Lumen agent gets exactly one bot — the
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://lumen.ai/docs${prefix}/slack-bot-integration`;
}
