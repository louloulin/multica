...
vi.mock("@lumen/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@lumen/core/github")>("@lumen/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Lumen will stop receiving webhooks/i)).toBeTruthy();
