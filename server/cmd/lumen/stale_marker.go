...
//
// Any LUMEN_* task identity in the environment means the daemon really did
// launch this process, so the marker is doing its job. LUMEN_DAEMON_PORT
...
func leftoverDaemonTaskMarkerPath() string {
	if inAgentExecutionContext() ||
		...
		strings.TrimSpace(os.Getenv("LUMEN_DAEMON_PORT")) != "" {
		return ""
	}
