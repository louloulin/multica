...
// handler package (same convention as the X-Lumen-Next-Before cursors in
...
Examples:
  ...
  lumen issue timeline MUL-123 --action status_changed

  # Every state change, no comment bodies
  lumen issue timeline MUL-123 --activity-only --output json

  # What changed since yesterday?
  lumen issue timeline MUL-123 --since 2026-08-19T00:00:00Z`,
	Args: exactArgs(1),
