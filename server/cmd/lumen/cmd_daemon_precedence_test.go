...
func TestResolveDaemonStringOverridePrecedence(t *testing.T) {
	const envName = "TEST_LUMEN_STR_OVERRIDE"
...
func TestResolveDaemonWorkspacesRootPrecedence(t *testing.T) {
	...
	t.Setenv("LUMEN_WORKSPACES_ROOT", envRoot)
	...
	wantDefault := filepath.Join(home, "lumen_workspaces_dev")
	if got != wantDefault {
...
func TestResolveDaemonDurationOverridePrecedence(t *testing.T) {
	const envName = "TEST_LUMEN_DUR_OVERRIDE"
...
func TestResolveDaemonIntOverridePrecedence(t *testing.T) {
	const envName = "TEST_LUMEN_INT_OVERRIDE"
...
func TestResolveDaemonAgentTimeoutOverridePrecedence(t *testing.T) {
	const envName = "TEST_LUMEN_AGENT_TIMEOUT"
...
func TestResolveDaemonDisableSignalPrecedence(t *testing.T) {
	const envName = "TEST_LUMEN_DAEMON_AUTO_UPDATE"
