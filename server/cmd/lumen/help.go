...
var rootHelpTemplate = `Work seamlessly with Lumen from the command line.

USAGE
  lumen <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ lumen daemon start
  $ lumen agent list --output json

ENVIRONMENT VARIABLES
  LUMEN_SERVER_URL    Override the default server URL
  LUMEN_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`lumen <command> <subcommand> --help`" + ` for more information about a command.
`
