...
func TestNewDaemonLogRotatorEnvOverride(t *testing.T) {
	t.Setenv("LUMEN_DAEMON_LOG_MAX_SIZE_MB", "5")
	t.Setenv("LUMEN_DAEMON_LOG_MAX_BACKUPS", "2")
	t.Setenv("LUMEN_DAEMON_LOG_MAX_AGE_DAYS", "7")
...
func TestDaemonLogRotatorRotates(t *testing.T) {
	t.Setenv("LUMEN_DAEMON_LOG_MAX_SIZE_MB", "1")
	t.Setenv("LUMEN_DAEMON_LOG_MAX_BACKUPS", "3")
