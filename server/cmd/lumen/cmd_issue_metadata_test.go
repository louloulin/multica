...
// Tests for `lumen issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue lumen-ai/lumen#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `lumen issue metadata list <issue> --output json`
