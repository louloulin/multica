...
//   - populates the task-local `skills/` dir with ONLY the Lumen-bound skills,
...
//     Lumen product concern — the host's local Hermes memory must not bleed
...
const hermesTaskLocalStateMarker = ".lumen-task-local-state-v1"
...
// Lumen-bound skills. They keep their natural slug (no user skills share this
