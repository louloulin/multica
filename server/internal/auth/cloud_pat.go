...
// (Lumen Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Lumen Cloud Fleet service rather than by hitting our
...
// LUMEN_CLOUD_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.lumen.cloud). Trailing slashes are trimmed.
