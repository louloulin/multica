...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.lumen.ai"
	cookieDomain string // cookie scope, e.g. ".lumen.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.lumen.ai")
//   - COOKIE_DOMAIN           (e.g. ".lumen.ai")
