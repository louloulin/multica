...
func TestCreateSquad_PlainMemberBecomesCreator(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-creator@lumen.test")
...
func TestManageSquad_CreatorCanManageOwn(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-owner-manage@lumen.test")
...
func TestManageSquad_StrangerMemberForbidden(t *testing.T) {
	...
	creatorID := createPlainMember(t, "squad-stranger-creator@lumen.test")
	strangerID := createPlainMember(t, "squad-stranger-other@lumen.test")
