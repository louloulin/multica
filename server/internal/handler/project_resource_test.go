...
func TestProjectResourceLifecycle(t *testing.T) {
	...
	if ref.URL != "https://github.com/lumen-ai/lumen" {
...
func TestProjectResourceAcceptsSSHRepoURLs(t *testing.T) {
	...
	cases := []struct {
		...
		{"scp-like", "git@github.com:lumen-ai/lumen.git"},
		{"ssh-scheme", "ssh://git@github.com/lumen-ai/lumen.git"},
	}
...
func TestIsValidGitRepoURL(t *testing.T) {
	good := []string{
		...
		"ssh://git@github.com/lumen-ai/lumen.git",
		"ssh://git@github.com:22/lumen-ai/lumen.git",
	...
	bad := []string{
		"",
		"not-a-url",
		"github.com/lumen-ai/lumen", // no scheme, no scp-style colon
		"https://",                      // empty host
...
func TestCreateProjectAttachesResources(t *testing.T) {
	...
	req := newRequest("POST", "/api/projects?workspace_id="+testWorkspaceID, map[string]any{
		...
		"resources": []map[string]any{
			{
				"resource_type": "github_repo",
				"resource_ref":  map[string]any{"url": "https://github.com/lumen-ai/lumen"},
			},
		},
	})
	testHandler.CreateProject(w, req)
...
func TestProjectResourceCountBreadcrumb(t *testing.T) {
	...
	req = newRequest("POST", "/api/projects/"+project.ID+"/resources", map[string]any{
		"resource_type": "github_repo",
		"resource_ref":  map[string]any{"url": "https://github.com/lumen-ai/breadcrumb"},
	})
	req = withURLParam(req, "id", project.ID)
	testHandler.CreateProjectResource(w, req)
	if w.Code != http.StatusCreated {
...
func TestCreateProjectWithResourcesEchoesCount(t *testing.T) {
	...
	req := newRequest("POST", "/api/projects?workspace_id="+testWorkspaceID, map[string]any{
		...
		"resources": []map[string]any{
			{
				"resource_type": "github_repo",
				"resource_ref":  map[string]any{"url": "https://github.com/lumen-ai/echo-count"},
			},
		},
	})
	testHandler.CreateProject(w, req)
...
func TestProjectResourceRejectsInvalidCheckoutRef(t *testing.T) {
	...
	if clearedRef.URL != "https://github.com/lumen-ai/lumen" {
