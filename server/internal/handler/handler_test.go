...
const (
	handlerTestEmail         = "handler-test@lumen.ai"
...
func TestSendCode(t *testing.T) {
	w := httptest.NewRecorder()
	body := map[string]string{"email": "sendcode-test@lumen.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	...
	t.Cleanup(func() {
		testPool.Exec(context.Background(), `DELETE FROM verification_code WHERE email = $1`, "sendcode-test@lumen.ai")
	})
}
...
func TestSendCodeDbError(t *testing.T) {
	...
	w := httptest.NewRecorder()
	body := map[string]string{"email": "dberror-test@lumen.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	req := httptest.NewRequest("POST", "/auth/send-code", &buf)
	req.Header.Set("Content-Type", "application/json")
...
func TestSendCodeRateLimit(t *testing.T) {
	const email = "ratelimit-test@lumen.ai"
	t.Cleanup(func() {
...
func TestVerifyCode(t *testing.T) {
	const email = "verify-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsDevCodeUnlessExplicitlyConfigured(t *testing.T) {
	...
	const email = "dev-code-disabled-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeAcceptsConfiguredDevCodeOutsideProduction(t *testing.T) {
	...
	const email = "dev-code-enabled-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsConfiguredDevCodeInProduction(t *testing.T) {
	...
	const email = "dev-code-production-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeWrongCode(t *testing.T) {
	...
	const email = "wrong-code-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeBruteForceProtection(t *testing.T) {
	...
	const email = "bruteforce-test@lumen.ai"
	ctx := context.Background()
...
func TestVerifyCodeNewUserHasNoWorkspace(t *testing.T) {
	const email = "workspace-verify-test@lumen.ai"
	ctx := context.Background()
