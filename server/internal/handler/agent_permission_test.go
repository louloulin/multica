...
func TestCanInvokeAgent_PublicToMemberWhitelist(t *testing.T) {
	...
	allowedMember := createPermissionTestMember(t, "perm-allowed-member@lumen.test")
	otherMember := createPermissionTestMember(t, "perm-other-member@lumen.test")
...
func TestCanInvokeAgent_MixedMemberAndTeamTargets(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-mix-a@lumen.test")
	memberB := createPermissionTestMember(t, "perm-mix-b@lumen.test")
...
func TestUpdateAgent_BatchReplaceOverlappingMembers(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-batch-a@lumen.test")
	memberB := createPermissionTestMember(t, "perm-batch-b@lumen.test")
	memberC := createPermissionTestMember(t, "perm-batch-c@lumen.test")
...
func TestUpdateAgent_WorkspaceStacksWithMembersThenNarrowed(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-stack-a@lumen.test")
	memberB := createPermissionTestMember(t, "perm-stack-b@lumen.test")
	...
	memberC := createPermissionTestMember(t, "perm-stack-c@lumen.test")
	w := httptest.NewRecorder()
	r := newRequest("PUT", "/api/agents/"+agentID, map[string]any{
		"permission_mode": "public_to",
		"invocation_targets": []map[string]any{
...
func TestCreateAgent_EmptyPublicToNormalizesToWorkspace(t *testing.T) {
	...
	someMember := createPermissionTestMember(t, "perm-emptypublic-m@lumen.test")
...
func TestCanInvokeAgent_SystemWorkspaceExceptionAndMemberFailClosed(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-sys-failclosed@lumen.test")
...
func TestRevokeMember_ClearsInvocationTargets(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-revoke-x@lumen.test")
...
func TestRevokeMember_InvocationTargetCleanupIsWorkspaceScoped(t *testing.T) {
	...
	userX := createPermissionTestMember(t, "perm-xws@lumen.test")
...
func TestUpdateAgent_AccessChangeIsOwnerOnly(t *testing.T) {
	...
	adminID := createPermissionTestAdmin(t, "perm-access-admin@lumen.test")
...
func TestUpdateAgent_LegacyVisibilityNoOpForMemberOnlyPublicTo(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-legacyvis-x@lumen.test")
	agentID := createPublicToAgentWithTargets(t, "legacy-vis-member-only-agent", []map[string]any{
		{"target_type": "member", "target_id": memberX},
	})
	adminID := createPermissionTestAdmin(t, "perm-legacyvis-admin@lumen.test")
