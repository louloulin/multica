...
func TestAutopilotCollaborator_GrantedMemberCanWrite(t *testing.T) {
	...
	member := createPlainMember(t, "ap-collab-grantee@lumen.test")
...
func TestAutopilotCollaborator_NonWriterCannotGrant(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-collab-stranger@lumen.test")
	victim := createPlainMember(t, "ap-collab-victim@lumen.test")
...
func TestAutopilotCollaborator_CannotManageAccessList(t *testing.T) {
	...
	carol := createPlainMember(t, "ap-collab-carol@lumen.test")
	dave := createPlainMember(t, "ap-collab-dave@lumen.test")
	bob := createPlainMember(t, "ap-collab-bob2@lumen.test")
...
func TestAutopilotWrite_PlainMemberCannotMutateOthers(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-stranger@lumen.test")
...
func TestAutopilotWrite_CreatorCanMutateOwn(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-creator@lumen.test")
...
func TestAutopilotWrite_AdminCanMutateMembersAutopilot(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-admin-target@lumen.test")
...
func TestAutopilotWrite_WebhookSecretRedactedForNonWriter(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-perm-secret-stranger@lumen.test")
