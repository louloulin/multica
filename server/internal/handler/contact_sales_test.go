...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@lumen.ai", "ada@lumen.ai", true},
		{"uppercase normalized", "Ada@Lumen.AI", "ada@lumen.ai", true},
		{"trim whitespace", "  ada@lumen.ai  ", "ada@lumen.ai", true},
		{"display name stripped", "Ada Lovelace <ada@lumen.ai>", "ada@lumen.ai", true},
		{"angle-bracketed", "<ada@lumen.ai>", "ada@lumen.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@lumen.ai", "", false},
