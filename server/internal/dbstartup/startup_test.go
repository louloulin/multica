...
func TestParsePoolConfigPreservesNativeConnectTimeout(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			cfg, err := ParsePoolConfig(tt.databaseURL, tt.lumenValue)
			if err != nil {
				t.Fatalf("ParsePoolConfig: %v", err)
			}
