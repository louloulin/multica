---
name: lumen-platform
description: "Use for Lumen platform actions the runtime brief does not fully cover: issue and PR contracts, mentions, agents, squads, autopilots, projects, runtimes, skill import. Not for the product code you are working on."
user-invocable: false
allowed-tools: Bash(lumen *), Bash(git *), Bash(gh *)
---
...
is unclear, `lumen <command> --help` beats guessing at flags.
