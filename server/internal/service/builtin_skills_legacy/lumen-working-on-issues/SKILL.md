---
name: lumen-working-on-issues
description: "Superseded by the lumen-platform skill — load that instead. This file only records where the Lumen issue contracts moved to."
user-invocable: false
allowed-tools: Bash(lumen *)
---

# Moved into `lumen-platform`

Lumen's platform contracts are now one skill. Everything this skill used to
...
```text
lumen-platform  →  references/issues.md
```

Load the `lumen-platform` skill and open that file. Its routing table also
...
You are seeing this redirect because the Lumen app on this machine is older
