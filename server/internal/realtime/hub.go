...
// loadTrustedProxies reads the same LUMEN_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("LUMEN_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared LUMEN_TRUSTED_PROXIES value in here at startup.
