...
var businessMetricLabels = map[string][]string{
	"lumen_agent_task_enqueued_total":                {labelSource, labelRuntimeMode},
	"lumen_agent_task_dispatched_total":              {labelSource, labelRuntimeMode},
	"lumen_agent_task_started_total":                 {labelSource, labelRuntimeMode, labelProvider},
	"lumen_agent_task_terminal_total":                {labelSource, labelRuntimeMode, labelTerminalStatus},
	"lumen_agent_task_failed_total":                  {labelSource, labelRuntimeMode, labelFailureReason},
	"lumen_agent_task_queue_wait_seconds":            {labelSource, labelRuntimeMode},
	"lumen_agent_task_claimable_wait_seconds":        {labelSource, labelRuntimeMode},
	"lumen_agent_task_run_seconds":                   {labelSource, labelRuntimeMode, labelTerminalStatus},
	"lumen_agent_task_total_seconds":                 {labelSource, labelRuntimeMode, labelTerminalStatus},
	"lumen_agent_task_in_progress":                   {labelSource, labelRuntimeMode},
	"lumen_agent_task_iteration_count":               {labelSource, labelTerminalStatus},
	"lumen_llm_tokens_total":                         {labelProvider, labelModel, labelTokenType, labelRuntimeMode, labelSource},
	"lumen_llm_cost_usd_total":                       {labelProvider, labelModel, labelTokenType, labelRuntimeMode, labelSource},
	"lumen_llm_unpriced_tokens_total":                {labelProvider, labelModelAlias, labelTokenType},
	"lumen_llm_request_total":                        {labelProvider, labelModel, labelRuntimeMode},
	"lumen_task_queued_expired_total":                {labelSource, labelRuntimeMode},
	"lumen_task_lease_expired_total":                 {labelSource},
	"lumen_chat_claim_session_fallback_needed_total": {},
	"lumen_chat_claim_session_fallback_result_total": {labelResult},
	"lumen_chat_claim_resume_query_duration_seconds": {labelQuery},
	"lumen_runtime_sweeper_stage_duration_seconds":   {labelStage},
	"lumen_runtime_sweeper_candidate_rows_total":     {labelStage},
	"lumen_runtime_sweeper_rows_changed_total":       {labelStage},
	"lumen_agent_runtime_lookup_total":               {labelSource, labelResult},
	"lumen_issue_metadata_mutation_total":            {labelOp, labelResult},
	"lumen_issue_metadata_mutation_duration_seconds": {labelOp, labelResult},

	// PR3 funnel / community / commercial.
	"lumen_signup_total":                             {labelSignupSource},
	"lumen_workspace_created_total":                  {labelSource},
	"lumen_team_invite_sent_total":                   {},
	"lumen_team_invite_accepted_total":               {},
	"lumen_onboarding_started_total":                 {labelPlatform},
	"lumen_onboarding_questionnaire_submitted_total": {},
	"lumen_onboarding_source_submitted_total":        {},
	"lumen_onboarding_completed_total":               {labelPath},
	"lumen_cloud_waitlist_joined_total":              {},
	"lumen_issue_created_total":                      {labelSource, labelPlatform},
	"lumen_chat_message_sent_total":                  {labelPlatform},
	"lumen_agent_created_total":                      {labelRuntimeMode, labelSource},
	"lumen_squad_created_total":                      {},
	"lumen_autopilot_created_total":                  {labelCadence},
	"lumen_issue_executed_total":                     {labelSource},
	"lumen_runtime_registered_total":                 {labelRuntimeMode, labelProvider},
	"lumen_runtime_ready_total":                      {labelRuntimeMode, labelProvider},
	"lumen_runtime_ready_seconds":                    {labelRuntimeMode, labelProvider},
	"lumen_runtime_failed_total":                     {labelRuntimeMode, labelProvider, labelFailureReason, labelRecoverable},
	"lumen_runtime_offline_total":                    {labelRuntimeMode, labelProvider},
	"lumen_runtime_gc_skipped_total":                 {labelReason},
	"lumen_daemon_ws_message_received_total":         {labelKind},
	"lumen_autopilot_run_started_total":              {labelCadence, labelTriggerKind},
	"lumen_autopilot_run_terminal_total":             {labelCadence, labelTriggerKind, labelTerminalStatus},
	"lumen_autopilot_run_skipped_total":              {labelCadence, labelReason},
	"lumen_webhook_delivery_total":                   {labelProvider, labelStatus},
	"lumen_webhook_rate_limited_total":               {labelGate},
	"lumen_email_rate_limited_total":                 {labelAction, labelGate},
	"lumen_github_event_received_total":              {labelEventKind, labelAction},
	"lumen_github_pr_review_total":                   {labelResult},
	"lumen_cloudruntime_request_total":               {labelOp, labelStatus},
	"lumen_cloudruntime_request_duration_seconds":    {labelOp},
	"lumen_feedback_submitted_total":                 {labelKind, labelPlatform},
	"lumen_contact_sales_submitted_total":            {labelSource},
	"lumen_chat_output_local_path_total":             {labelKind},
	"lumen_entitlement_cache_total":                  {labelOutcome},
	"lumen_entitlement_refresh_total":                {labelOutcome},
	"lumen_entitlement_refresh_duration_seconds":     {labelOutcome},
	"lumen_entitlement_decision_total":               {labelGate, labelAction, labelReason},
	"lumen_entitlement_version_regression_total":     {},
	"lumen_autopilot_quota_decision_total":           {labelAction, labelSource, labelResult},
}
