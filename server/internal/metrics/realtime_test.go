...
func TestRealtimeCollectorExposesCounters(t *testing.T) {
	...
	for _, want := range []string{
		"lumen_realtime_active_connections 3",
		"lumen_realtime_messages_sent_total 11",
		"lumen_realtime_inbound_too_large_total 7",
		"lumen_realtime_redis_connected 1",
		`lumen_realtime_redis_mirror_errors_total{target="primary"} 2`,
		`lumen_realtime_redis_mirror_errors_total{target="secondary"} 5`,
		"lumen_realtime_redis_stream_trimmed_entries_total 13",
		"lumen_realtime_redis_stream_missing_total 1",
		"lumen_realtime_redis_streams_without_ttl 2",
		"lumen_realtime_redis_used_memory_bytes 4096",
		"lumen_realtime_redis_maxmemory_bytes 8192",
		"lumen_realtime_redis_evicted_keys 3",
		`lumen_realtime_redis_stream_entries{stream="ws:relay:shard:0"} 23`,
		`lumen_realtime_redis_stream_pttl_milliseconds{stream="ws:relay:shard:0"} 60000`,
	} {
