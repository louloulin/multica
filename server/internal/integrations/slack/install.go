...
// app-level token (xapp-) into Lumen (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Lumen workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Lumen workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Lumen
