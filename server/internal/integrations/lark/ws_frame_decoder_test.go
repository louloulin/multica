...
func TestLarkJSONFrameDecoderPostMessageFlattened(t *testing.T) {
	t.Parallel()
	postContent := `{"title":"周报","content":[[{"tag":"text","text":"本周完成："}],[{"tag":"text","text":"Lark 集成"},{"tag":"a","href":"https://github.com/lumen-ai/lumen/pull/3277","text":"PR #3277"}]]}`
	...
	want := "周报\n本周完成：\nLark 集成 PR #3277 (https://github.com/lumen-ai/lumen/pull/3277)"
	if msg.Body != want {
