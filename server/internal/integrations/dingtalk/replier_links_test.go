...
func TestIssueMarkdownIdentifierUsesWorkspaceAndStableID(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "identifier", base: "https://lumen.example/", slug: "team-b", key: "ALHE-6", want: "[ALHE\\-6](https://lumen.example/team-b/issues/" + id + ")"},
		{name: "number uses UUID target", base: "https://lumen.example", slug: "team-b", number: 6, want: "[\\#6](https://lumen.example/team-b/issues/" + id + ")"},
		{name: "UUID display fallback", base: "https://lumen.example", slug: "team-b", want: "[11111111\\-2222\\-4333\\-8444\\-555555555555](https://lumen.example/team-b/issues/" + id + ")"},
		{name: "local app", base: "http://localhost:3000", slug: "team-b", key: "ALHE-6", want: "[ALHE\\-6](http://localhost:3000/team-b/issues/" + id + ")"},
		{name: "base path", base: " https://lumen.example/apps/lumen/ ", slug: "team-b", key: "ALHE-6", want: "[ALHE\\-6](https://lumen.example/apps/lumen/team-b/issues/" + id + ")"},
		{name: "parentheses in base path", base: "https://lumen.example/apps/(dev)", slug: "team-b", key: "ALHE-6", want: "[ALHE\\-6](https://lumen.example/apps/%28dev%29/team-b/issues/" + id + ")"},
		{name: "missing base", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		{name: "invalid base", base: "https://[", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		{name: "missing scheme", base: "lumen.example", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		...
		{name: "credentials", base: "https://user:secret@lumen.example", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		{name: "query", base: "https://lumen.example?token=private", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		{name: "fragment", base: "https://lumen.example#other", slug: "team-b", key: "ALHE-6", want: "ALHE-6"},
		{name: "missing workspace", base: "https://lumen.example", key: "ALHE-6", want: "ALHE-6"},
		{name: "missing issue ID", base: "https://lumen.example", slug: "team-b", key: "ALHE-6", missingID: true, want: "ALHE-6"},
	} {
...
func TestReplierMissingIssueLinkConfigStillConfirms(t *testing.T) {
	for _, tc := range []struct{ name, appURL, slug string }{
		...
		{"missing result workspace slug", "https://lumen.example", ""},
	} {
		t.Run(tc.name, func(t *testing.T) {
