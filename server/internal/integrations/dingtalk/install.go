...
// (client secret) into Lumen (the paste path lives in byo_install.go). The
...
var (
	...
	// is already connected to a live owner in a DIFFERENT Lumen workspace — it
	...
	ErrRobotOwnedByAnotherWorkspace = errors.New("dingtalk: this DingTalk robot is already connected to a different Lumen workspace")
