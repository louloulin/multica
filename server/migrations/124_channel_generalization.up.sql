...
--
--     PRD (rolling lumen-api, maxUnavailable:0) overlapped old and new pods.
--     A one-time LUMEN_LARK_HUB_DISABLED park-switch existed during the
...
CREATE INDEX idx_channel_user_binding_user
    ON channel_user_binding(lumen_user_id, workspace_id);
...
INSERT INTO channel_user_binding (
    id, workspace_id, lumen_user_id, installation_id,
