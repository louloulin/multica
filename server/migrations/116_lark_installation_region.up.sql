-- Add a per-installation `region` so one Lumen deployment can serve
...
-- deployment-wide value (the LUMEN_LARK_HTTP_BASE_URL /
-- LUMEN_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
