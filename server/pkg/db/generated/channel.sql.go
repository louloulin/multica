...
RETURNING id, workspace_id, lumen_user_id, installation_id, channel_type, channel_user_id, config, bound_at
`
...
func (q *Queries) DeleteChannelUserBindingsByWorkspaceMember(ctx context.Context, arg DeleteChannelUserBindingsByWorkspaceMemberParams) error {
	_, err := q.db.Exec(ctx, deleteChannelUserBindingsByWorkspaceMember, arg.WorkspaceID, arg.LumenUserID)
	return err
}

const findChannelBindingForMember = `-- name: FindChannelBindingForMember :one
SELECT b.id, b.workspace_id, b.lumen_user_id, b.installation_id, b.channel_type, b.channel_user_id, b.config, b.bound_at FROM channel_user_binding b
JOIN channel_installation ci ON ci.id = b.installation_id
WHERE b.workspace_id = $1
  AND b.lumen_user_id = $2
...
func (q *Queries) FindChannelBindingForMember(ctx context.Context, arg FindChannelBindingForMemberParams) (ChannelUserBinding, error) {
	row := q.db.QueryRow(ctx, findChannelBindingForMember, arg.WorkspaceID, arg.LumenUserID, arg.ChannelType)
	var i ChannelUserBinding
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
...
SELECT id, workspace_id, lumen_user_id, installation_id, channel_type, channel_user_id, config, bound_at FROM channel_user_binding
